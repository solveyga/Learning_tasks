...
@pytest.mark.parametrize(
    "input_value", ["The quick brown fox jumps over the lazy dog.", "いろはにほへと"]
)
def test_letter_list_no_cyrillic(
    input_value, control_empty_vowels, control_empty_consonants
):
    control_vowels = control_empty_vowels
    control_consonants = control_empty_consonants
