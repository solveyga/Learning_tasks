...
"""Тест для цифры, из которой можно составить стробограмматическое число. Но записанное одной цифрой число не будет стробограмматическим."""
assert False == is_strobogram_number("6")
